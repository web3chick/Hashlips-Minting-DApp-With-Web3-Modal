...
const providerOptions = {
  walletconnect: {
    ...
    options: {
      ...
      rpc: {
        5: "https://goerli.infura.io/v3/", // Goerli Testnet
      },
    },
  },
  walletlink: {
    ...
    options: {
      appName: "Hashlips", // Required
      infuraId: "", // Required unless you provide a JSON RPC url; see `rpc` below
      rpc: "https://goerli.infura.io/v3/", // Optional if `infuraId` is provided; otherwise it's required
